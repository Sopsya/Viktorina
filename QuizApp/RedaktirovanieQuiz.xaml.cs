...
namespace QuizApp
{
    public partial class RedaktirovanieQuiz : Window
    {
        public Quiz EditedQuiz { get; private set; }

        public RedaktirovanieQuiz(Quiz quiz)
        {
            InitializeComponent();
            EditedQuiz = quiz;
        ...
        private void AddQuestionButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (addQuestionWindow.ShowDialog() == true)
            {
                ...
                if (questions != null) questions.Add(addQuestionWindow.NewQuestion);
        ...
        private void EditOptionsButton_Click(object sender, RoutedEventArgs e)
        {
            if ((sender as Button)?.Tag is Question selectedQuestion)
            {
                ...
                var optionsWindow = new Variant(options);
