...
namespace QuizApp
{
    public partial class Vopros : Window
    {
        ...
        public Vopros() => InitializeComponent();
        private void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (var option in OptionsTextBox.Text.Split(new[] { "\r\n", "\n", "\r" }, System.StringSplitOptions.RemoveEmptyEntries)) options.Add(option.Trim()); // Удаляем пробелы и другие лишние символы в начале/конце
